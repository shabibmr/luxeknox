...
class MembershipFreezeHistoryScreen extends StatefulWidget {
  const MembershipFreezeHistoryScreen({super.key});

  @override
  State<MembershipFreezeHistoryScreen> createState() =>
      _MembershipFreezeHistoryScreenState();
}

class _MembershipFreezeHistoryScreenState
    extends State<MembershipFreezeHistoryScreen> {
    ...
    return Scaffold(
      ...
      body: _loading
          ...
          : SingleChildScrollView(
              child: MembershipFreezeList(membershipId: _membershipId!),
            ),
    );
  }
}

...
class NOTIFApi {
  ...
  const NOTIFApi(this._dio, this._serializers);
  ...
  Future<Response<Notification>> broadcastNotification({ 
    required BroadcastRequest broadcastRequest,
    ...
    final _path = r'/notifications/broadcast';
    ...
    try {
      const _type = FullType(BroadcastRequest);
      _bodyData = _serializers.serialize(broadcastRequest, specifiedType: _type);
  ...
  Future<Response<void>> deleteDevice({ 
    ...
    final _path = r'/devices/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(int)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NotificationPage>> listBroadcasts({ 
    int? limit,
    int? offset,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/notifications/broadcasts';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> markAllNotificationsRead({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
  ...
  /// Returns a [Future] containing a [Response] with a [Notification] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<Notification>> markNotificationRead({ 
    required int id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  Future<Response<Device>> registerDevice({ 
    required DeviceWrite deviceWrite,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(DeviceWrite);
      _bodyData = _serializers.serialize(deviceWrite, specifiedType: _type);

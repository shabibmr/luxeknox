...
part 'membership_product_write.g.dart';
...
/// * [isActive] 
@BuiltValue()
abstract class MembershipProductWrite implements Built<MembershipProductWrite, MembershipProductWriteBuilder> {
  ...
  MembershipProductWrite._();

  factory MembershipProductWrite([void updates(MembershipProductWriteBuilder b)]) = _$MembershipProductWrite;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MembershipProductWriteBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MembershipProductWrite> get serializer => _$MembershipProductWriteSerializer();
}

class _$MembershipProductWriteSerializer implements PrimitiveSerializer<MembershipProductWrite> {
  @override
  final Iterable<Type> types = const [MembershipProductWrite, _$MembershipProductWrite];

  @override
  final String wireName = r'MembershipProductWrite';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    MembershipProductWrite object, {
  ...
  void _deserializeProperties(
    ...
    required MembershipProductWriteBuilder result,
  ...
  @override
  MembershipProductWrite deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MembershipProductWriteBuilder();

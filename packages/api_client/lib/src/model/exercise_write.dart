...
/// * [isActive] 
@BuiltValue()
abstract class ExerciseWrite implements Built<ExerciseWrite, ExerciseWriteBuilder> {
  ...
  factory ExerciseWrite([void updates(ExerciseWriteBuilder b)]) = _$ExerciseWrite;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(ExerciseWriteBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<ExerciseWrite> get serializer => _$ExerciseWriteSerializer();
}

class _$ExerciseWriteSerializer implements PrimitiveSerializer<ExerciseWrite> {
  @override
  final Iterable<Type> types = const [ExerciseWrite, _$ExerciseWrite];

  @override
  final String wireName = r'ExerciseWrite';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    ExerciseWrite object, {
  ...
  void _deserializeProperties(
    ...
    required ExerciseWriteBuilder result,
  ...
  @override
  ExerciseWrite deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = ExerciseWriteBuilder();

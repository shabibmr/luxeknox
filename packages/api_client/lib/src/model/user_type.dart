...
class UserType extends EnumClass {
  ...
  static const UserType member = _$member;
  @BuiltValueEnumConst(wireName: r'trainer')
  static const UserType trainer = _$trainer;
  @BuiltValueEnumConst(wireName: r'employee')
  static const UserType employee = _$employee;

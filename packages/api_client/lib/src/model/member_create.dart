...
/// * [notes] 
@BuiltValue()
abstract class MemberCreate implements Built<MemberCreate, MemberCreateBuilder> {
  ...
  factory MemberCreate([void updates(MemberCreateBuilder b)]) = _$MemberCreate;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(MemberCreateBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<MemberCreate> get serializer => _$MemberCreateSerializer();
}

class _$MemberCreateSerializer implements PrimitiveSerializer<MemberCreate> {
  @override
  final Iterable<Type> types = const [MemberCreate, _$MemberCreate];

  @override
  final String wireName = r'MemberCreate';
  ...
  void _deserializeProperties(
    ...
    required MemberCreateBuilder result,
  ...
  @override
  MemberCreate deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = MemberCreateBuilder();

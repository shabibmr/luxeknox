...
abstract class RoleWrite implements Built<RoleWrite, RoleWriteBuilder> {
  ...
  static void _defaults(RoleWriteBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<RoleWrite> get serializer => _$RoleWriteSerializer();
}

class _$RoleWriteSerializer implements PrimitiveSerializer<RoleWrite> {
  @override
  ...
  void _deserializeProperties(
    ...
    required RoleWriteBuilder result,

...
import 'package:api_client/src/api/api_api.dart';
import 'package:api_client/src/api/attn_api.dart';
import 'package:api_client/src/api/auth_api.dart';
import 'package:api_client/src/api/dash_api.dart';
import 'package:api_client/src/api/diet_api.dart';
import 'package:api_client/src/api/goal_api.dart';
import 'package:api_client/src/api/health_api.dart';
import 'package:api_client/src/api/media_api.dart';
import 'package:api_client/src/api/memb_api.dart';
...
import 'package:api_client/src/api/sys_api.dart';
...
class ApiClient {
  ...
  /// Get ATTNApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  ATTNApi getATTNApi() {
    return ATTNApi(dio, serializers);
  }
  ...
  /// Get DASHApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  DASHApi getDASHApi() {
    return DASHApi(dio, serializers);
  }
  ...
  /// Get GOALApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  GOALApi getGOALApi() {
    return GOALApi(dio, serializers);
  }
  ...
  /// Get MEMBApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  MEMBApi getMEMBApi() {
    return MEMBApi(dio, serializers);
  }

  /// Get NOTIFApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  NOTIFApi getNOTIFApi() {
    return NOTIFApi(dio, serializers);
  }

  /// Get PAYApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  PAYApi getPAYApi() {
    return PAYApi(dio, serializers);
  }
  ...
  /// by doing that all interceptors will not be executed
  RBACApi getRBACApi() {
    return RBACApi(dio, serializers);
  }

  /// Get RPTApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  RPTApi getRPTApi() {
    return RPTApi(dio, serializers);
  }

  /// Get SCHEDApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  SCHEDApi getSCHEDApi() {
    return SCHEDApi(dio, serializers);
  }

  /// Get SYSApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  SYSApi getSYSApi() {
    return SYSApi(dio, serializers);
  }
